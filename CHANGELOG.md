...
* **api:** filter notification templates by tag [C-21172] ([#131](https://github.com/trycourier/courier-cli/issues/131)) ([70f23c3](https://github.com/trycourier/courier-cli/commit/70f23c313b6fe888663a09854346229b04da451d))
...
* **api:** document Slack and MS Teams on journey send nodes, and fix over-strict MsTeams tenant requirements [C-20302] ([#105](https://github.com/trycourier/courier-cli/issues/105)) ([0952553](https://github.com/trycourier/courier-cli/commit/0952553c8a549336b8274e900efa7414ccf314a8))
...
* **api:** nest the AWS SNS target_arn under aws_sns on the user profile ([#94](https://github.com/trycourier/courier-cli/issues/94))

### Features

* **api:** nest the AWS SNS target_arn under aws_sns on the user profile ([#94](https://github.com/trycourier/courier-cli/issues/94)) ([4550519](https://github.com/trycourier/courier-cli/commit/455051923a5ba87baf2a0b830932871f24ce6b7d))
