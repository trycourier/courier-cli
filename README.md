...
You can link the CLI against a different version of the Courier Go SDK
...
```bash
./scripts/link ../path/to/courier-go
```

If you run the link script without any arguments, it will default to `../courier-go`.
