...
import (
	...
	"github.com/trycourier/courier-cli/v5/internal/autocomplete"
		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					&broadcastsCancel,
					&broadcastsDuplicate,
					&broadcastsPutContent,
					&broadcastsRetrieveContent,
					&broadcastsSchedule,
					&broadcastsSend,
				},
			},
			...
			{
				Name:     "workspace-preferences:topics",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&workspacePreferencesTopicsCreate,
			...
			},
			{
				...
				Commands: []*cli.Command{
					...
					&usersPreferencesBulkReplace,
					&usersPreferencesBulkUpdate,
